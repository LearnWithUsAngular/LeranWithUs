...
export class DetailComponent implements OnInit {
  ...
  onWindowScroll() {
    if (window.innerHeight + window.scrollY === document.body.scrollHeight) {
      console.log('end');
      this.document
        .getElementById('sidebar-img')
        ?.setAttribute('style', 'opacity:1;display:block');
      this.document
        .getElementById('sidebar')
        ?.setAttribute('style', 'position:fixed; z-index:0;top:-45%;');
    } else if (
      ...
      this.document
        .getElementById('sidebar-img')
        ?.setAttribute('style', 'opacity:0;display:none');
      this.document
        .getElementById('sidebar')
        ?.setAttribute('style', 'position:fixed; z-index:1;top:2%');
    } else if (
      ...
      this.document
        .getElementById('sidebar')
        ?.setAttribute('style', 'position:absolute; z-index:0;top:15%');
    }
  }
}
@Component({
