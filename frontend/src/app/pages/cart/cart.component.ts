...
export class CartComponent implements OnInit {
  ...
  productItem: any = [
    ...
    {id: 2, name: 'Tesla X', price:133000, imageUrl: 'http://st.motortrend.com/uploads/sites/5/2016/03/2016-Tesla-Model-X-P90D-front-three-quarter-doors-open.jpg'},
    {id: 3, name: 'Tesla S', price: 102000, imageUrl:'https://media.ed.edmunds-media.com/tesla/model-s/2016/oem/2016_tesla_model-s_sedan_p90d_fq_oem_2_1280.jpg'},
  ]
  ...
  onCartUpdated(event: any) {
    ...
    if (cindex===-1) {
      ...
      this.cartItems[cindex].quantity++;
